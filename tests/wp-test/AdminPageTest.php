...
class AdminPageTest extends WP_UnitTestCase {
    ...
    function test_guest_should_have_no_admin_menu_entries() {
        ...
        // $this->assertEmpty(menu_page_url('event-data-data', false));
        $this->assertEmpty(menu_page_url('event-data-settings', false));
        $this->assertEmpty(menu_page_url('event-data-secrets', false));
    }
    ...
    function test_user_with_data_permissions_should_have_data_menu_entry() {
        ...
        $this->assertNotEmpty(menu_page_url('event-data-data', false));
        $this->assertEmpty(menu_page_url('event-data-settings', false));
        $this->assertEmpty(menu_page_url('event-data-secrets', false));
    }
    ...
    function test_administrator_should_have_all_admin_menu_entries() {
        ...
        $this->assertNotEmpty(menu_page_url('event-data-data', false));
        $this->assertNotEmpty(menu_page_url('event-data-settings', false));
        $this->assertNotEmpty(menu_page_url('event-data-secrets', false));
    }
